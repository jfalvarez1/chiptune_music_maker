...
Every image below is generated by the app itself with
`tools/generate-gallery.ps1`, which drives its `--capture` mode and reads the
rendered frame straight out of OpenGL. They can be regenerated after any UI
